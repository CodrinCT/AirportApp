...
public class FlightInfoDao {
    ...
    public FlightInfoModel getInfo (ResultSet resultSet, int rowNum) throws SQLException {
    ...
    public Integer getNrSeats(ResultSet resultSet, int rowNum) throws SQLException {
    ...
    public Integer getNrSeatsAvailable(ResultSet resultSet, int rowNum) throws SQLException {
        FlightInfoModel flightInfoModel = new FlightInfoModel();
